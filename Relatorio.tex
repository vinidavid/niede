...
\label{sec:ladder}
A implementação ladder do sistema pode ser vista a seguir, para facilitar as demonstrações e o processo de depuração, nós diminuímos o tempo de enchimento do tanque para 5 segundos e o tempo de maturação da cerveja para 25 segundos.
...
\appendix
\newpage
\includepdf[scale=0.6,pages={1},pagecommand=\section{Tabela de Variáveis}]{table.pdf}
\label{apx:table}
\includepdf[scale=0.6, pages={2-}]{table.pdf}
\includepdf[scale=0.68,pages={1},pagecommand=\section{Detalhes da IHM}]{ihm.pdf}
\label{apx:ihm}
